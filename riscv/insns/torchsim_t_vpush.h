// torchsim_t_vpush -- one vector register into the transpose unit, a row per lane.
// IT DOES NOT FIRE THE TRANSPOSE, unlike the systolic array's push: a column is not
// known until every row is in, so `t_vpop` is what runs it.
